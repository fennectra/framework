...
class User extends Model
{
    ...
    public function hasRole(string $roleName): bool
    {
        $stmt = DB::raw(
            ...
            ['user_id' => $this->id, 'role_name' => $roleName]
        );
...
class Auth
{
    ...
    public function handle(array $params = []): void
    {
        ...
        // Store user ID in request for controllers
        $_REQUEST['__auth_user_id'] = $user->id;
    ...
    private function validateToken(string $token): ?User
    {
        ...
        $secret = Env::get('JWT_SECRET', 'fennec-secret');
